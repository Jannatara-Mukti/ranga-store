...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="bg-secondary border-2 border-secondary text-white rounded m-2 p-2">
      <div>
...
const updatePrice = (id, value, count) => {
